...
<head>
    ...
    <link rel="stylesheet" href="scss/check.css">
    <title>Проверить статус ремонта</title>
</head>
<body>
<header class="header">
...
<section class="hero">
    <div class="container">
        ...
        <h1 class="hero__title">Проверяйте статус ремонта в любое для вас удобное время</h1>
    </div>
</section>
<section class="check">
    <div class="container">
